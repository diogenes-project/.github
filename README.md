...
[diogenes-project](https://github.com/diogenes-project) GitHub
organization.
...
| Path | Purpose |
|---|---|
| `profile/README.md` | Org profile page — renders on the [diogenes-project landing page](https://github.com/diogenes-project) |
